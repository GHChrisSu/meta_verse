...
export class CameraController extends Component {
  ...
  public leftExit() {
    ...
    this._targetRotation = new Quat(
      EnvironmentController.Instance.PlayerObject.worldRotation
    );
  ...
  private handleCameraInput(event: EventMouse) {
    ...
    switch (event.eventType) {
      ...
      case SystemEventType.MOUSE_WHEEL:
        ...
        this._desiredZoom = Vec3.lerp(
          tempVec,
          new Vec3(0, this.minZoom.x, this.minZoom.y),
          new Vec3(0, this.maxZoom.x, this.maxZoom.y),
          this._currentZoom
        );
        break;
    }
